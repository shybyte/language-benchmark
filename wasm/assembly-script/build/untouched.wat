(module
 ...
 (import "index" "time" (func $assembly/index/time))
 (import "index" "timeEnd" (func $assembly/index/timeEnd))
 (global $assembly/index/MAX_AUTHORS i32 (i32.const 10000))
 ...
 (data (i32.const 528) "\05\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\a4\00\00\00\00\00\00\00$\01\00\00\00\00\00\00")
 (table $0 1 funcref)
 (elem $0 (i32.const 1))
 (export "createLines" (func $assembly/index/createLines))
 ...
 (func $~lib/staticarray/StaticArray<u16>#__uset (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $0
  local.get $1
  i32.const 1
  i32.shl
 ...
 (func $~lib/staticarray/StaticArray<u16>#__uget (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.const 1
  i32.shl
 ...
 (func $assembly/index/main
  ...
  i32.const 1000
  i32.mul
  call $assembly/index/createLines
  local.tee $0
  i32.store
  local.get $0
  call $~lib/staticarray/StaticArray<u16>#get:length
  ...
  global.get $~lib/memory/__stack_pointer
  i32.const 0
  global.get $assembly/index/MAX_AUTHORS
  call $~lib/staticarray/StaticArray<u32>#constructor
  local.tee $1
  i32.store offset=4
  call $assembly/index/time
  local.get $0
  call $~lib/staticarray/StaticArray<u16>#get:length
  local.set $2
  i32.const 0
  ...
  loop $for-loop|0
   ...
   if
    local.get $0
    local.get $3
    call $~lib/staticarray/StaticArray<u16>#__uget
    local.set $5
    local.get $1
    local.get $5
    local.get $1
     ...
     block $~lib/arraybuffer/ArrayBufferView
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        ...
        i32.sub
        i32.load
        br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/staticarray/StaticArray<u16> $~lib/staticarray/StaticArray<u32> $invalid
       end
       return
      end
      return
 ...
 (func $~lib/staticarray/StaticArray<u16>#constructor (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/index/createLines (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
